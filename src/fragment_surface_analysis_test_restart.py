...
def main():
    ...
    for ts in frames:
        ...
        # Stop for testing restart after processing frame 2
        if frame >= 3:
            print(f"Stopping at frame {frame} for testing restart.")
            sys.exit(1) # Exit with error code 1 to simulate crash for testing
