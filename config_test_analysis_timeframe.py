...
ANALYSIS_PARAMETERS = {
    "general": {
        ...
        "base_input_dir": "data/short",
        # Base directory for all output files
        "base_output_dir": "output/test_analysis_timeframe",

        # Input file paths relative to base_input_dir
        "psf_file": "0HPt.psf",
        "dcd_file": "Pt+0HNEC.dcd", # Pointing to data/short/Pt+0HNEC.dcd
    },      
    "simulation_info": {
    ...
    "residence_event_analysis": {
        ...
        "max_off_time": 0.0002, # Increased maximum off-surface time
    },
    "binding_metrics": {
        ...
        # Parameters for timeframe-specific analysis
        "analysis_start_frame": 2, # Optional start frame index (inclusive) for the analysis window.
        "analysis_end_frame": 8, # Optional end frame index (exclusive) for the analysis window.
        # min_res_time is passed from residence_event_analysis section by pipeline.py
    }
}
...
class AnalysisConfig:
    def __init__(self, parameters=ANALYSIS_PARAMETERS):
        ...
        self.binding_metrics_analysis_start_frame = self.params["binding_metrics"].get("analysis_start_frame", None)
        self.binding_metrics_analysis_end_frame = self.params["binding_metrics"].get("analysis_end_frame", None)
