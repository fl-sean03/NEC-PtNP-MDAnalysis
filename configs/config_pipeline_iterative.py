...
ANALYSIS_PARAMETERS = {
    "general": {
        ...
        "base_input_dir": "data/short", # Updated input directory
        # Base directory for all output files
        "base_output_dir": "output/test_iterative_pipeline", # Updated output directory

        # Input file paths relative to base_input_dir
        "psf_file": "0HPt.psf", # Updated PSF file
        "dcd_file": "Pt+0HNEC.dcd", # Updated DCD file
    },
    "simulation_info": {
    ...
    "residence_event_analysis": {
        ...
        "min_res_time": 0.0001, # Reduced minimum residence time
    ...
    "iterative_binding_metrics": {
        ...
        "frame_step": 1, # Example value, adjust as needed
...
class AnalysisConfig:
    def __init__(self, parameters=ANALYSIS_PARAMETERS):
        ...
        self.iterative_binding_metrics_output_dir = os.path.join(self.base_output_dir, "iterative_binding_metrics")
        ...
        os.makedirs(self.iterative_binding_metrics_output_dir, exist_ok=True)
        ...
        self.fragment_surface_analysis_start_frame = self.params["fragment_surface_analysis"].get("start_frame", None)
        self.fragment_surface_analysis_end_frame = self.params["fragment_surface_analysis"].get("end_frame", None)
        ...
        # --- Iterative Binding Metrics Parameters ---
        self.iterative_binding_metrics_frame_step = self.params["iterative_binding_metrics"]["frame_step"]
        self.iterative_binding_metrics_verbose = self.params["iterative_binding_metrics"]["verbose"]
        ...
        self.iterative_binding_metrics_csv = os.path.join(
            self.iterative_binding_metrics_output_dir,
            "iterative_facet_results.csv"
        )
